...
![1](E:\Notebook\06 - 图解 HTTP\06 - HTTP 首部\images\1.png)
...
![2](E:\Notebook\06 - 图解 HTTP\06 - HTTP 首部\images\2.png)

下面的示例是访问 `http://hackr.jp` 时， 请求报文的首部信息。 

![3](E:\Notebook\06 - 图解 HTTP\06 - HTTP 首部\images\3.png)

#### HTTP 响应报文

在响应中， HTTP 报文由 HTTP 版本、 状态码（数字和原因短语） 、HTTP 首部字段 3 部分构成。 

![4](E:\Notebook\06 - 图解 HTTP\06 - HTTP 首部\images\4.png)

以下示例是之前请求访问 `http://hackr.jp/` 时， 返回的响应报文的首部信息。 

![5](E:\Notebook\06 - 图解 HTTP\06 - HTTP 首部\images\5.png)
...
![6](E:\Notebook\06 - 图解 HTTP\06 - HTTP 首部\images\6.png)

### 6.2.2 HTTP 首部字段结构 

HTTP 首部字段是由首部字段名和字段值构成的， 中间用冒号 `:`分隔。

![7](E:\Notebook\06 - 图解 HTTP\06 - HTTP 首部\images\7.png)

例如， 在 HTTP 首部中以 Content-Type 这个字段来表示报文主体的对象类型。 

![8](E:\Notebook\06 - 图解 HTTP\06 - HTTP 首部\images\8.png)

就以上述示例来看， 首部字段名为 Content-Type， 字符串 text/html 是字段值。 

另外， 字段值对应单个 HTTP 首部字段可以有多个值， 如下所示。

![9](E:\Notebook\06 - 图解 HTTP\06 - HTTP 首部\images\9.png)
...
![10](E:\Notebook\06 - 图解 HTTP\06 - HTTP 首部\images\10.png)

#### 2. 请求首部字段

![11](E:\Notebook\06 - 图解 HTTP\06 - HTTP 首部\images\11.png)

#### 3. 响应首部字段

![12](E:\Notebook\06 - 图解 HTTP\06 - HTTP 首部\images\12.png)

#### 4. 实体首部字段

![13](E:\Notebook\06 - 图解 HTTP\06 - HTTP 首部\images\13.png)
...
![14](E:\Notebook\06 - 图解 HTTP\06 - HTTP 首部\images\14.png)

指令的参数是可选的，多个指令之间通过 `,` 分隔。首部字段 CacheControl 的指令可用于请求及响应时。 

可用的指令按请求和响应分类如下所示。 ![15](E:\Notebook\06 - 图解 HTTP\06 - HTTP 首部\images\15.png)

![16](E:\Notebook\06 - 图解 HTTP\06 - HTTP 首部\images\16.png)
...
![17](E:\Notebook\06 - 图解 HTTP\06 - HTTP 首部\images\17.png)

在客户端发送请求和服务器返回响应内，使用 Connection 首部字段， 可控制不再转发给代理的首部字段（即 Hop-by-hop 首部） 。 

**管理持久连接：** 

![18](E:\Notebook\06 - 图解 HTTP\06 - HTTP 首部\images\18.png)

HTTP/1.1 版本的默认连接都是持久连接。 为此， 客户端会在持久连接上连续发送请求。 当服务器端想明确断开连接时， 则指定 Connection 首部字段的值为 Close。 

![19](E:\Notebook\06 - 图解 HTTP\06 - HTTP 首部\images\19.png)
...
![20](E:\Notebook\06 - 图解 HTTP\06 - HTTP 首部\images\20.png)
...
![21](E:\Notebook\06 - 图解 HTTP\06 - HTTP 首部\images\21.png)

**首部字段 Trailer 会事先说明在报文主体后记录了哪些首部字段。该首部字段可应用在 HTTP/1.1 版本分块传输编码时。** 

### 6.3.6 Transfer-Encoding 

![22](E:\Notebook\06 - 图解 HTTP\06 - HTTP 首部\images\22.png)
...
![23](E:\Notebook\06 - 图解 HTTP\06 - HTTP 首部\images\23.png)
...
首部字段 Via 不仅用于追踪报文的转发， 还可避免请求回环的发生。所以必须在经过代理时附加该首部字段内容。 ![24](E:\Notebook\06 - 图解 HTTP\06 - HTTP 首部\images\24.png)
...
![25](E:\Notebook\06 - 图解 HTTP\06 - HTTP 首部\images\25.png)
...
![26](E:\Notebook\06 - 图解 HTTP\06 - HTTP 首部\images\26.png)
...
![27](E:\Notebook\06 - 图解 HTTP\06 - HTTP 首部\images\27.png)

Accept-Charset 首部字段可用来通知服务器用户代理支持的字符集及字符集的相对优先顺序。 另外， 可一次性指定多种字符集。 与首部字段 Accept 相同的是可用权重 q 值来表示相对优先级。 

### 6.4.3 Accept-Encoding 

![28](E:\Notebook\06 - 图解 HTTP\06 - HTTP 首部\images\28.png)

Accept-Encoding 首部字段用来告知服务器用户代理支持的内容编码及内容编码的优先级顺序。 可一次性指定多种内容编码。 

### 6.4.4 Accept-Language 

![29](E:\Notebook\06 - 图解 HTTP\06 - HTTP 首部\images\29.png)
...
![30](E:\Notebook\06 - 图解 HTTP\06 - HTTP 首部\images\30.png)
...
![31](E:\Notebook\06 - 图解 HTTP\06 - HTTP 首部\images\31.png)

客户端使用首部字段 Expect 来告知服务器，期望出现的某种特定行为。因服务器无法理解客户端的期望作出回应而发生错误时，会返回状态码 417 Expectation Failed。 

### 6.4.7 From 

![32](E:\Notebook\06 - 图解 HTTP\06 - HTTP 首部\images\32.png)
...
![33](E:\Notebook\06 - 图解 HTTP\06 - HTTP 首部\images\33.png)
...
![34](E:\Notebook\06 - 图解 HTTP\06 - HTTP 首部\images\34.png)

**形如 If-xxx 这种样式的请求首部字段， 都可称为条件请求。**

服务器接收到附带条件的请求后，只有判断指定条件为真时，才会执行请求。 

![35](E:\Notebook\06 - 图解 HTTP\06 - HTTP 首部\images\35.png)

### 6.4.10 If-Modified-Since 

![36](E:\Notebook\06 - 图解 HTTP\06 - HTTP 首部\images\36.png)
...
![37](E:\Notebook\06 - 图解 HTTP\06 - HTTP 首部\images\37.png)
...
![38](E:\Notebook\06 - 图解 HTTP\06 - HTTP 首部\images\38.png)

首部字段 If-Range 属于附带条件之一。它告知服务器若指定的 If-Range 字段值（ETag 值或者时间）和请求资源的 ETag 值或时间相一致时，则作为范围请求处理。 反之， 则返回全体资源。

![39](E:\Notebook\06 - 图解 HTTP\06 - HTTP 首部\images\39.png)
...
![40](E:\Notebook\06 - 图解 HTTP\06 - HTTP 首部\images\40.png)
...
![41](E:\Notebook\06 - 图解 HTTP\06 - HTTP 首部\images\41.png)
...
![42](E:\Notebook\06 - 图解 HTTP\06 - HTTP 首部\images\42.png)
...
![43](E:\Notebook\06 - 图解 HTTP\06 - HTTP 首部\images\43.png)
...
![44](E:\Notebook\06 - 图解 HTTP\06 - HTTP 首部\images\44.png)
...
![45](E:\Notebook\06 - 图解 HTTP\06 - HTTP 首部\images\45.png)
...
![46](E:\Notebook\06 - 图解 HTTP\06 - HTTP 首部\images\46.png)
...
![47](E:\Notebook\06 - 图解 HTTP\06 - HTTP 首部\images\47.png)

首部字段 Retry-After 告知客户端应该在多久之后再次发送请求。 主要配合状态码 503 Service Unavailable 响应， 或 3xx Redirect 响应一起使用。 

### 6.5.7 Server 

![48](E:\Notebook\06 - 图解 HTTP\06 - HTTP 首部\images\48.png)

首部字段 Server 告知客户端当前服务器上安装的 HTTP 服务器应用程序的信息。 不单单会标出服务器上的软件应用名称， 还有可能包括版本号和安装时启用的可选项。

### 6.5.8 Vary 

![49](E:\Notebook\06 - 图解 HTTP\06 - HTTP 首部\images\49.png)
...
![50](E:\Notebook\06 - 图解 HTTP\06 - HTTP 首部\images\50.png)

在请求和响应两方的 HTTP 报文中都含有与实体相关的首部字段。

 ### 6.6.1 Allow 

![51](E:\Notebook\06 - 图解 HTTP\06 - HTTP 首部\images\51.png)
...
![52](E:\Notebook\06 - 图解 HTTP\06 - HTTP 首部\images\52.png)

 ### 6.6.3 Content-Language 

![53](E:\Notebook\06 - 图解 HTTP\06 - HTTP 首部\images\53.png)

首部字段 Content-Language 会告知客户端， 实体主体使用的自然语言（指中文或英文等语言）。

### 6.6.4 Content-Length 

![54](E:\Notebook\06 - 图解 HTTP\06 - HTTP 首部\images\54.png)
...
![55](E:\Notebook\06 - 图解 HTTP\06 - HTTP 首部\images\55.png)
...
![56](E:\Notebook\06 - 图解 HTTP\06 - HTTP 首部\images\56.png)
...
![57](E:\Notebook\06 - 图解 HTTP\06 - HTTP 首部\images\57.png)
...
![58](E:\Notebook\06 - 图解 HTTP\06 - HTTP 首部\images\58.png)
...
![59](E:\Notebook\06 - 图解 HTTP\06 - HTTP 首部\images\59.png)

### 6.7.1 Set-Cookie 

![60](E:\Notebook\06 - 图解 HTTP\06 - HTTP 首部\images\60.png)
